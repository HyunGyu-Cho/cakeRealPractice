...
public enum ProductErrorCode implements ErrorCode {
    ...
    CATEGORY_NOT_FOUND("PRODUCT_004", "상품 분류를 찾을 수 없습니다. 카테고리 시드를 적용해 주세요.", 500),
    INSUFFICIENT_STOCK("PRODUCT_005", "상품 재고가 부족합니다.", 409),
    STOCK_UPDATE_FAILED("PRODUCT_006", "상품 재고를 변경하지 못했습니다.", 500);
